import{K as n,w as a}from"./index-Dnfh4pL-.js";let s=0;const c=()=>(s+=1,s);class m{AVERAGE_PROCESSING_MINUTES=35;async checkInClient(e,t){try{n("CheckInService: checking in client",e);const i=await a({query:`mutation CheckInClient($clientId: String!, $notes: String) {
